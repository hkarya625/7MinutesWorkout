...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setRestProgressBar(){
        ...
        restTime = object:CountDownTimer(restTimerDuration * 30000, 1000){     // 10sec(end) interval between tick
    ...
    private fun setupExerciseView(){
        ...
        speakOut(exerciseList!![currentExercisePosition].getName())  // speak the name of exercise
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer =
            object : CountDownTimer(exerciseTimerDuration*1000, 1000) {     // 30sec(end) interval between tick
                override fun onTick(millisUntilFinished: Long) {
                    exerciseProgress++
